    ...
    return (
        <section style={{ backgroundColor: '#FDF5E6' }} className='bg-brand bg-brand-container'>
            ...
            <div className="container">
                ...
                <div style={{ borderRadius: '1rem', boxShadow: '0 5px 15px #c4c4c44d', backgroundColor: '#EADBC8' }} className="p-5 mt-4 mx-auto">
                    <h3 className='fs-5 fw-bold'>{product.name}</h3>
                    <hr />
                    {/* <p style={{ textAlign: 'justify', whiteSpace: 'pre-line', fontSize: '1rem', margin: '0' }} className='fs-6'>{product.description}</p> */}
                    <hr />
