...
const Navbar = () => {
    ...
    return (
        <nav style={{ backgroundColor: '#FDF5E6' }} className="navbar navbar-expand-lg customize-navbar sticky-top">
            <div className="container">

                <NavLink className="navbar-brand" to="/">
                <img src={logo} width={50} style={{ borderRadius: '50%' }} className='img-fluid' alt="logo" />Inhand Styles
                </NavLink>
